---
title: "Visualisation P2ST 2020"
author: "Quadrat études"
output: 
...
<h4> L'outil de visualisation </h4>
Cet outil de visualisation intéractif présente une synthèse du contexte d'activité, des enjeux d'emploi et de gestion des ressources humaines de la branche. Les statistiques sont réalisées à partir d'une enquête auprès des structures pour l'année 2020 et de sources publiques (DARES, INSEE, DADS).

Le premier volet présente le périmètre de la branche : l'évolution des effectifs, leur répartition géographique, par taille d'entreprise... Le second dresse le portrait social des salariés au 31 décembre 2020. Le dernier se concentre sur la formation professionnelle et l'alternance. Ces traitements statistiques sont réalisés à partir des données OPCO EP.
...
<h4> Mode d'emploi </h4>
Il est tout d'abord conseillé à l'utilisateur d'adapter le niveau de zoom de son navigateur, notamment dézoomer sur petit écran. L'utilisateur peut ensuite explorer les différents volets. Il est alors invité à passer la souris sur les éléments des graphiques pour obtenir plus de détails et à cliquer sur des boutons pour lancer les animations. En voici une démonstration :

###
```{r picture, out.width = '100%'}
knitr::include_graphics("GIFa_comp.gif")
```
...
Périmètre d'étude du rapport de branche {data-orientation=columns}
=======================================================================
...
### 
```{r}
valueBox("134 900","Salariés présents au 31/12, correspondant à 100 100 équivalents temps plein (ETP).", icon="fa-users")
```
...
-----------------------------------------------------------------------
### Evolution de l'emploi dans la branche P2ST
```{r}
...
### Pyramide des ages des salariés de la branche
```{r}
...
fam_met$metierS <- c("Informaticien", "Logisticien", "Ouvrier d'entretien", "Directeur de structure", "Cadre admin. et financier", "Employé administratif", "Secrétaire", "Traducteur", "Optimisateur de linéaire", "Promoteur des ventes", "Employé commercial", "Responsable commercial", "Chargé de dév. commercial", "Animateur commercial", "Chargé de recouvrement", "Télévendeur", "Enquêteur", "Directeur commercial", "Hôte d'accueil")
...
### Une branche fortement féminisée
```{r}
...
Formation professionnelle et alternance {data-columns=rows}
=======================================================================

Column {data-width=500}
-----------------------------------------------------------------------
<center><h4><b> Formation en alternance </b></h4></center>
...
Column {data-width=500}
-----------------------------------------------------------------------
<center><h4><b> Formation professionnelle </b></h4></center>
...
###
```{r}
valueBox("14,9M€", "Montant engagés pour les formations non-certifiantes en 2020, contribuant ainsi à accompagner l'évolution des besoins de compétences ", icon="fa-euro-sign")
```
